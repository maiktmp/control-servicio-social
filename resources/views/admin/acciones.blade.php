      ...
      <div class="ourstory">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <h4 class="title"><a href="{!! asset('users/')!!}">Usuarios</a></h4>
          ...
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <h4 class="title"><a href="{!! asset('alumnos_internos/')!!}">Alumnos internos</a></h4>
          ...
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <h4 class="title"><a href="{!! asset('alumnos_externos/')!!}">Alumnos externos</a></h4>
          ...
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <h4 class="title"><a href="{!! asset('laboratoristas/')!!}">Laboratoristas</a></h4>
          ...
          <div class="col-lg-4 col-md-6 icon-box">
            ...
            <h4 class="title"><a href="{!! asset('departamentos/')!!}">Departamentos</a></h4>
