                    ...
                    @forelse ($registers as $register)
                        <tr>
                            ...
                            <td class="text-center d-flex justify-content-center">
                                ...
                                <a href="{{route("labo_comment_create", ["registerId" => $register->id, "type"=>$type])}}"
                                ...
                                <a href="{{route("labo_check_update_hours",["registerId"=>$register->id, "type"=>$type])}}"
                                ...
                                @if($register->check === null)
                                    <a href="{{route("labo_check_register", ["registerId" => $register->id, "type"=>$type])}}"
